...
<div class="{{ $classes_container }}">
    ...
    <h4 class="transition duration-150 text-gray-800 dark:text-gray-200 hover:text-green-600 dark:hover:text-green-300 {{ $classes_date }}">{{ Helpers::parse_time_to_user_timezone($start_time)->format('M j, Y') }}</h4>
