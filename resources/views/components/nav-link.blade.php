...
<a {{ $attributes->merge(['class' => 'inline-flex items-center px-1 py-2 border-b-2 text-sm font-medium leading-5 text-gray-900 dark:text-gray-100 transition duration-150 ease-in-out ' .$extra_classes]) }}>
    {{ $slot }}
</a>
