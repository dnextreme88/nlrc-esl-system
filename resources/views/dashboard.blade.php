    ...
    <div class="py-12">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-4 md:gap-6 lg:grid-cols-2 *:p-4 sm:*:rounded-lg">
                ...
                @if (Helpers::is_student_role() || Helpers::is_teacher_role())
                    <div class="bg-gray-200 dark:bg-gray-600 shadow-md shadow-gray-500 {{ Helpers::is_student_role() ? 'col-span-2 lg:col-span-1' : '' }}">
