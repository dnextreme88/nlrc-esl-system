        ...
        @if ($mediaType === 'youtube')
            @php
                ...
                if (isset($parsedUrl['host'])) {
                    // Check if it's a youtu.be short URL by getting the path and extracting the video ID
                    if (strpos($parsedUrl['host'], 'youtu.be') !== false) {
                        $youtubeId = ltrim($parsedUrl['path'], '/');
                    } else if (strpos($parsedUrl['host'], 'youtube.com') !== false) { // Check if it's a regular youtube.com URL
